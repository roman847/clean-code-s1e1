...
var editTask = function () {
  ...
  var editBtn = listItem.querySelector(".todo__action-text");
  var containsClass = listItem.classList.contains("todo__list-item");
  ...
  listItem.classList.toggle("todo__list-item");
};
...
var bindTaskEvents = function (taskListItem, checkBoxEventHandler) {
  ...
  var editButton = taskListItem.querySelector(".todo__action-text");
